...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #N` y solicitar revisión a `@DSPerezIglesiasBurquet2026/reviewers`.
...
`https://github.com/DSPerezIglesiasBurquet2026/SmartPantry/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
